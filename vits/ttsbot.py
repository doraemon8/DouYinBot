...
from vits.utils import load_checkpoint, HParams
...
class TTSBot:
    ...
    def infer(self,text, language="zh", speed=0.8):
        ...
        sf.write(wav_bytes, audio, self.hps.data.sampling_rate, format='WAV', subtype='PCM_16')
